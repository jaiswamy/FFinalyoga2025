...
<html>
 ...
 <img src="../images/yogaheader2.png" class="img-fluid" alt="Responsive Image" style="border-radius:3px;width:100%;"  />
</div>
...
--%><g:hasErrors bean="${internationalCertificateInstance}">
			...
			<g:form url="[resource:internationalCertificateInstance, action:'save']" >
				<fieldset class="form">
