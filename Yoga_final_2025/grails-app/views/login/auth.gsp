...
<head>
<meta charset="utf-8" />
<title>IDY 2023 certificate</title>
<meta http-equiv="X-UA-Compatible" content="IE=edge">
<meta content="width=device-width, initial-scale=1" name="viewport" />
<meta content="International Day Of Yoga 2023" name="description" />
...
<body class=" login">
	 ...
	 <div>
	    ...
	    <img src="../images/8.jpg" class="img-fluid" alt="Responsive Image" style="width:100%;height:800px;">   
	   		<g:link controller="InternationalCertificate" action="create"> <button class="btn btn-primary btn-center" style="background-color: orangered;font-size: 25px;font-weight:bold;border:2px solid black;">Generate Certificate</button></g:link>
