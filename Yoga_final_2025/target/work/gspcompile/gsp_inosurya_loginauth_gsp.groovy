...
class gsp_inosurya_loginauth_gsp extends GroovyPage {
...
printHtmlPart(1)
invokeTag('captureMeta','sitemesh',12,['gsp_sm_xmlClosingForEmptyTag':("/"),'content':("International Day Of Yoga 2023"),'name':("description")],-1)
printHtmlPart(1)
...
invokeTag('link','g',51,['controller':("InternationalCertificate"),'action':("create")],2)
printHtmlPart(6)
})
invokeTag('captureBody','sitemesh',134,['class':(" login")],1)
printHtmlPart(7)
}
...
public static final long LAST_MODIFIED = 1687273097272L
