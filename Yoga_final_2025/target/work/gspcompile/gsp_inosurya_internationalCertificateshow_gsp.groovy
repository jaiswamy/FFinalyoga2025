...
class gsp_inosurya_internationalCertificateshow_gsp extends GroovyPage {
...
invokeTag('link','g',176,['controller':("internationalCertificate"),'action':("thankyou")],2)
printHtmlPart(12)
})
...
public static final long LAST_MODIFIED = 1688123164609L
