...
class gsp_yoga_internationalCertificateindex_gsp extends GroovyPage {
...
printHtmlPart(13)
invokeTag('sortableColumn','g',33,['property':("dob"),'title':(message(code: 'internationalCertificate.dob.label', default: 'Dob'))],-1)
printHtmlPart(13)
invokeTag('sortableColumn','g',35,['property':("gender"),'title':(message(code: 'internationalCertificate.gender.label', default: 'Gender'))],-1)
printHtmlPart(13)
invokeTag('sortableColumn','g',37,['property':("email"),'title':(message(code: 'internationalCertificate.email.label', default: 'Email'))],-1)
printHtmlPart(14)
loop:{
int i = 0
...
public static final long LAST_MODIFIED = 1687258004477L
