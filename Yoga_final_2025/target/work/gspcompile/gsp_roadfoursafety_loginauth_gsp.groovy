...
class gsp_roadfoursafety_loginauth_gsp extends GroovyPage {
...
invokeTag('link','g',56,['controller':("InternationalCertificate"),'action':("create")],2)
printHtmlPart(6)
})
...
public static final long LAST_MODIFIED = 1693031670507L
