...
class gsp_intyoga_loginauth_gsp extends GroovyPage {
...
invokeTag('link','g',50,['controller':("Certificate"),'action':("create")],2)
printHtmlPart(6)
})
...
public static final long LAST_MODIFIED = 1686655354000L
