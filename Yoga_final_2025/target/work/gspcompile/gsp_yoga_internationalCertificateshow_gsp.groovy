...
class gsp_yoga_internationalCertificateshow_gsp extends GroovyPage {
...
invokeTag('link','g',156,['controller':("internationalCertificate"),'action':("thankyou")],2)
printHtmlPart(10)
})
...
public static final long LAST_MODIFIED = 1687258510336L
